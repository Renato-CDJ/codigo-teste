        ...
        <DialogContent className="max-w-[95vw] sm:max-w-[90vw] md:max-w-[85vw] lg:max-w-[80vw] h-[90vh] flex flex-col p-0">
          ...
          <div className="flex flex-1 min-h-0 gap-0 overflow-hidden">
            ...
            <div className="w-64 border-r bg-muted/30 flex flex-col flex-shrink-0">
              ...
              {/* History button at bottom of sidebar */}
              {sidebarView !== "ranking" && (
                            ...
                            >
                              ...
                              <div className="flex justify-center mt-6 sm:mt-8">
                                <Button
                                  ...
                                  size="lg"
                                  variant="outline"
                                  className="px-8 sm:px-12 py-4 sm:py-6 text-base sm:text-lg md:text-xl hover:scale-105 transition-transform shadow-lg"
                                >
